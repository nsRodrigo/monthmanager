 ...
 * direto, com o contador de não lidas sempre visível — só na Home, pois nas
 * telas de conta/mês ele fica em cima do seletor de ano. A partir de md a
 * barra lateral fixa já mostra tudo isso, então nenhum dos dois aparece.
 */
export function AccountSettingsFab({ showNotifications = false }: { showNotifications?: boolean }) {
